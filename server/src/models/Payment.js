...
const paymentSchema = new mongoose.Schema(
  {
    // vendor_signup links to a Vendor; subscription/contactPack/seeker_signup link to a User
    type: { type: String, enum: ["vendor_signup", "subscription", "contactPack", "seeker_signup"], default: "vendor_signup" },
