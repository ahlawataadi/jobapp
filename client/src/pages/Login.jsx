...
export default function Login() {
  ...
  const [info] = useState(location.state?.activated ? "Your account is activated — log in to continue." : "");
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-card-hover border border-gray-100">
        ...
        {info && (
          <p className="text-green-700 text-sm mb-3 bg-green-50 border border-green-100 rounded-lg px-3 py-2">
            {info}
          </p>
        )}
        {error && (
